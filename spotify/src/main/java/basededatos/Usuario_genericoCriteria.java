...
public class Usuario_genericoCriteria extends AbstractORMCriteria {
	...
	public Usuario_genericoCriteria(Criteria criteria) {
		super(criteria);
	...
	public Usuario_genericoCriteria(PersistentSession session) {
		this(session.createCriteria(Usuario_generico.class));
	}
	
	public Usuario_genericoCriteria() throws PersistentException {
	...
	public Usuario_generico uniqueUsuario_generico() {
		return (Usuario_generico) super.uniqueResult();
	}
	
	public Usuario_generico[] listUsuario_generico() {
