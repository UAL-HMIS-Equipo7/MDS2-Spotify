...
public class ArtistaCriteria extends AbstractORMCriteria {
	...
	public AlbumCriteria createAlbumesCriteria() {
		return new AlbumCriteria(createCriteria("ORM_albumes"));
	}
