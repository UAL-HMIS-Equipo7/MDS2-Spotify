...
public class Usuario_genericoDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public Usuario_genericoDetachedCriteria() {
		super(basededatos.Usuario_generico.class, basededatos.Usuario_genericoCriteria.class);
	...
	public Usuario_genericoDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, basededatos.Usuario_genericoCriteria.class);
		id = new IntegerExpression("id", this.getDetachedCriteria());
		datosId = new IntegerExpression("datos.id", this.getDetachedCriteria());
		datos = new AssociationExpression("datos", this.getDetachedCriteria());
		nick = new StringExpression("nick", this.getDetachedCriteria());
	...
	public Usuario_generico uniqueUsuario_generico(PersistentSession session) {
		return (Usuario_generico) super.createExecutableCriteria(session).uniqueResult();
	}
	
	public Usuario_generico[] listUsuario_generico(PersistentSession session) {
