...
public class AplicacióndeBúsquedayReproduccióndeMúsicaPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "AplicacióndeBúsquedayReproduccióndeMúsica";
	...
	private AplicacióndeBúsquedayReproduccióndeMúsicaPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(basededatos.Usuario_generico.class);
		...
		aMetadataSources.addAnnotatedClass(basededatos.Datos_Acceso.class);
		aMetadataSources.addAnnotatedClass(basededatos.Administrador.class);
		aMetadataSources.addAnnotatedClass(basededatos.Estadistica.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new AplicacióndeBúsquedayReproduccióndeMúsicaPersistentManager();
		}
