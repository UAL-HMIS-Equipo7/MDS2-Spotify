...
<vaadin-vertical-layout style="width: 100%; height: 100%;">
 ...
 <vaadin-horizontal-layout theme="spacing" style="width: 100%; height: 40%; justify-content: space-around; margin-top: var(--lumo-space-m); margin-bottom: var(--lumo-space-m);" id="contenedorSuperior">
 ...
 <vaadin-horizontal-layout theme="spacing" style="width: 100%; height: 40%; justify-content: space-around; align-self: center; align-items: center; margin-bottom: var(--lumo-space-m); margin-top: var(--lumo-space-m);" id="contenedorInferior">
