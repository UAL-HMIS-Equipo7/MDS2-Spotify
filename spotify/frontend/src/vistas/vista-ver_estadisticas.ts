...
<vaadin-vertical-layout style="width: 100%; height: 100%;">
 <label id="tituloL" style="align-self: center;">Estadísticas de uso</label>
 <vaadin-horizontal-layout theme="spacing" style="width: 100%; height: 100%;">
  <vista-estilos_mas_escuchados style="width: 100%; height: 100%;"></vista-estilos_mas_escuchados>
  ...
  <vista-artistas_mas_escuchados style="width: 100%; height: 100%;"></vista-artistas_mas_escuchados>
