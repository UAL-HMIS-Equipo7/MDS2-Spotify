...
<vaadin-vertical-layout style="width: 100%; height: 100%;">
 ...
 <vaadin-horizontal-layout style="height: 48%; margin: var(--lumo-space-s); width: 98%; padding: var(--lumo-space-xs);" id="vaadinHorizontalLayout">
 ...
 <vaadin-horizontal-layout style="width: 98%; padding: var(--lumo-space-xs); height: 48%;" id="vaadinHorizontalLayout1">
